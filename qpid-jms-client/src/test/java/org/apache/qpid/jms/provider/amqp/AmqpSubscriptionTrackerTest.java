...
public class AmqpSubscriptionTrackerTest {
    ...
    private JmsConsumerInfo createConsumerInfo(String subscriptionName, String topicName, boolean shared, boolean durable, String selector, boolean hasClientID) {
        ...
        consumerInfo.setHasClientId(hasClientID);
